                        ...
                        >
                            ...
                            <div className="flex justify-between items-start mb-1">
                                <div className="flex items-center gap-2">
                                    <span className={`text-sm truncate ${!email.is_read && email.folder === 'inbox' ? 'text-white font-medium' : 'text-zinc-400'}`}>
                                        {email.sender}
                                    </span>
                                </div>
                            ...
                            <h3 className={`text-sm mb-1 truncate ${!email.is_read && email.folder === 'inbox' ? 'text-zinc-200 font-medium' : 'text-zinc-500'}`}>
                                {email.subject}
                            </h3>
                            ...
                            {/* Removed the absolute positioned dot from here */}
                                ...
                                <div className="flex gap-1 items-center">
                                    <button
                                        ...
                                        className={`p-1 rounded transition-all duration-200 hover:bg-zinc-700 
                                            ${email.isStarred
                                                ...
                                                : 'text-zinc-600 hover:text-zinc-300 opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0'
                                            }`}
                                    >
                                    ...
                                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-x-2 group-hover:translate-x-0">
                                        <button
                                            ...
                                            title={email.folder === "archive" ? "Move to Inbox" : "Archive"}
                                        >
